...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://08e7-2401-4900-5c56-9e3f-5daf-53a7-9ecd-7b20.in.ngrok.io"
    }
  }
          ...
          >
            ...
            <View style={styles.subContainer}>
              ...
              <View style={styles.iconButtonContainer}>
                <TouchableOpacity><Image style={styles.iconImage} source= {require('../assets/like.png')}></Image></TouchableOpacity>
                <TouchableOpacity>
